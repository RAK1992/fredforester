...
public class PersonFormController extends BaseFormController {
	...
	public void setPersonManager(
			@Qualifier("personManager") PersonManager personManager) {
	...
	protected Person showForm(HttpServletRequest request) throws Exception {
	...
	public String onSubmit(Person person, BindingResult errors,
